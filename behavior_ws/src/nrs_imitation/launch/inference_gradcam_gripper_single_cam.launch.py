...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("gripper_command_min_tick", default_value="590"),
        DeclareLaunchArgument("gripper_command_max_tick", default_value="2500"),
        ...
        DeclareLaunchArgument("gripper_cmd_safety_max_tick_from_present", default_value="700.0"),
